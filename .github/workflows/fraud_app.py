...
def predict(model, input_df):
    ...
    if score < 40:
        st.write("\n*This claim has NOT been flagged as potentially fraudulent.*")
    elif score > 39 and score < 59:
        st.write("\n*This claim is BORDERLINE, so may be worth paying attention to.*")
...
# for online predictions
    ...
    if add_selectbox == 'Manual Input':
        ...
        insured_hobbies = st.selectbox('Hobbies', [ #3
                'cross-fit','chess',
       ...
       'Multi-vehicle Collision', 'Parked Car'])
        ...
        incident_severity = st.selectbox('Incident severity', ['Minor Damage', 'Major Damage', 'Total Loss']) #12
...
#        st.write('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nThis app is intentded to help you sift through claims and alert you to the few that may be worth further investigation.')
